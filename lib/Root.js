...
Package.prototype = {
  install: function(release, hash, range, callback) {
    var module = release.module,
        dependency = {name: module.name, owner: module.owner, version: release.version, range: range, url: module.url, releaseUrl: release.url, sha: hash},
        i = bisect(this._index.dependencies, dependency),
        dependency0 = this._index.dependencies[i];
    this._index.dependencies.splice(i, dependency0 && dependency0.sha === hash, dependency);
